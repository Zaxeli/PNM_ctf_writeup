...
contract PNMDAORegistry {
    ...
    function isPNMDAOHacker(address who) public view returns (bool result) {
        return (PNMDAOHackers[who] > 0);
    }
